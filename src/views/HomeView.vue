      ...
      <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
        ...
        <h2 data-aos="fade-up" data-aos-delay="400" >We are team of talented website designers, developers & digital marketeers</h2>
          <div data-aos="fade-up" data-aos-delay="800" >
            <RouterLink to="/about" class="btn-get-started scrollto">Get Started</RouterLink>
          </div>
      </div>
      <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="https://akeshya.com/assets/img/hero-img.png" class="img-fluid animated" alt="">
        </div>
    </div>
  </div>
 </section>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-6">
            <img src="https://akeshya.com/assets/img/clients/client-1.png" class="img-fluid" alt="" data-aos="zoom-in">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="https://akeshya.com/assets/img/clients/client-2.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="100">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="https://akeshya.com/assets/img/clients/client-3.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="200">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="https://akeshya.com/assets/img/clients/client-4.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="300">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="https://akeshya.com/assets/img/clients/client-5.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="400">
          </div>

          <div class="col-lg-2 col-md-4 col-6">
            <img src="https://akeshya.com/assets/img/clients/client-6.png" class="img-fluid" alt="" data-aos="zoom-in" data-aos-delay="500">
          </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" >
            ...
            <RouterLink to="/services" class="btn-learn-more">Learn More</RouterLink>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="image col-xl-5 d-flex align-items-stretch justify-content-center justify-content-xl-start" >
            <img src="http://localhost:5173/src/assets/img/counts-img.svg" alt="" class="img-fluid">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card" style='background-image: url("assets/img/more-services-1.html");' data-aos="fade-up" data-aos-delay="100">
              <div class="card-body">
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="card" style='background-image: url("assets/img/more-services-2.html");' data-aos="fade-up" data-aos-delay="200">
              <div class="card-body">
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4">
            <div class="card" style='background-image: url("assets/img/more-services-3.html");' data-aos="fade-up" data-aos-delay="100">
              <div class="card-body">
          ...
          <div class="col-md-6 d-flex align-items-stretch mt-4">
            <div class="card" style='background-image: url("assets/img/more-services-4.html");' data-aos="fade-up" data-aos-delay="200">
              <div class="card-body">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="info">
              ...
              <div>
                ...
                <p><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="3a53545c557a5b515f4952435b14595557">[email&#160;protected]</a></p>
              </div>
      ...
      <div class="d-flex justify-content-between">
        ...
        <div>
          <ul class=" d-flex list-unstyled">
            <li class="px-3"><a href="Terms%20and%20conditions.pdf">Terms and conditions</a></li>
            <li class="px-3"><a href="Refund%20policy.pdf">Refund policy</a></li>
            <li class="px-3"><a href="Privacy%20policy.pdf">Privacy policy</a></li>
          </ul>
        </div>
      </div>
    </div>
